...
CREATE TABLE IF NOT EXISTS `mydb`.`TelefoneSolicitante` (
  ...
  INDEX `fk_TelefoneSolicitante_Solicitante_idx` (`Solicitante_CPF` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`TelefonePaciente` (
  ...
  INDEX `fk_TelefonePaciente_Paciente1_idx` (`Paciente_CPF` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`TelefoneFuncionario` (
  ...
  INDEX `fk_TelefoneFuncionario_Funcionario1_idx` (`Funcionario_CPF` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Prontuario` (
  ...
  `Funcionario_CPF` CHAR(11) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_Prontuario_Solicitante1_idx` (`Solicitante_CPF` ASC),
  INDEX `fk_Prontuario_Paciente1_idx` (`Paciente_CPF` ASC),
  INDEX `fk_Prontuario_Funcionario1_idx` (`Funcionario_CPF` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Unidade` (
  ...
  PRIMARY KEY (`CNPJ`),
  INDEX `fk_Unidade_Laboratorio1_idx` (`Laboratorio_CNPJ` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Exame` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_Exame_Unidade1_idx` (`Unidade_CNPJ` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`TelefoneUnidade` (
  ...
  INDEX `fk_TelefoneUnidade_Unidade1_idx` (`Unidade_CNPJ` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`TelefoneLaboratorio` (
  ...
  INDEX `fk_TelefoneLaboratorio_Laboratorio1_idx` (`Laboratorio_CNPJ` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Composto por` (
  ...
  `PrecoPago` DECIMAL(6,2) NOT NULL,
  PRIMARY KEY (`Prontuario_ID`, `Exame_ID`),
  INDEX `fk_Prontuario_has_Exame_Exame1_idx` (`Exame_ID` ASC),
  INDEX `fk_Prontuario_has_Exame_Prontuario1_idx` (`Prontuario_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Trabalha em` (
  ...
  INDEX `fk_Unidade_has_Funcionario_Funcionario1_idx` (`Funcionario_CPF` ASC),
  INDEX `fk_Unidade_has_Funcionario_Unidade1_idx` (`Unidade_CNPJ` ASC),
